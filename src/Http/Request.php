...
namespace EctemaApi\Http;

use EctemaApi\Base;
use EctemaApi\Cache\CacheAbstract;
use EctemaApi\Params;
use Exception;

/**
 * Class Request
 * @package EctemaApi\Http
 */
class Request extends Base
{
    ...
    public function send(): Response
    {
        ...
        curl_setopt($ch, CURLOPT_USERAGENT, 'Client version '. Client::CLIENT_VERSION);
